# Generated by Django 4.1.1 on 2022-09-06 02:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roaster', to='coffee2.user')),
            ],
        ),
        migrations.CreateModel(
            name='Bean',
            fields=[
                ...
                ('roaster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='beans_list', to='coffee2.roaster')),
            ],
        ),
    ]
